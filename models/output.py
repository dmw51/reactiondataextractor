...
from models.reaction import Diagram, ReactionStep
from models.segments import ReactionRoleEnum
from models.utils import Point, PrettyFrozenSet, PrettyList
...
class ReactionScheme(Graph):
    ...
    def __init__(self, conditions, diags):
    ...
    def __str__(self):
        ...
        # else:
        return str(self._pretty_reaction_steps)
